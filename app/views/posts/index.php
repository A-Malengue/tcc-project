...
<div class="new-Post">
        ...
        <textarea name="body" placeholder="Faça uma reclamação" ></textarea>
          ...
          <div class="icons-and-btn">
               <div class="icons">
            <button type="button" class="btn-file-form"><img src="<?php echo URLROOT; ?>/img/img.svg" alt="Adicione Uma imagem">
            </button>
    ...
    <form action="<?php echo URLROOT; ?>/posts/addcomment/"  class="form-Post" method="POST">
    <div class="img-User"><img src="<?php echo URLROOT; ?>/img/user-1.png" alt="" width= "35px" heigth="35px"></div>
    ...
    <input type="submit" name="comentario" value="Comentar">
